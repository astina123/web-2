                            ...
                            <div class="card-body">
                                <form action="proses_produk.php" method="POST">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input required id="kode" name="kode" type="text" class="form-control" placeholder="Contoh: BRG001">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input required id="harga" name="harga" type="number" class="form-control" min="0">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="stok" class="col-4 col-form-label">Stok</label>
                                        <div class="col-8">
                                            <input required id="stok" name="stok" type="number" class="form-control" min="0">
                                        </div>
                                    </div>
                                    <div class="form-group row">
